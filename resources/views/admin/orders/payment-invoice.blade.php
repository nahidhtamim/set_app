...
@section('contents')
                            ...
                            <div id="invoiceholder">
                              ...
                              <div id="invoice" class="effect2">
                                  ...
                                  <div id="invoice-top">
                                      ...
                                      <!--End Info-->
                                      <div class="title">
                                          <h1>Invoice #{{ $op->order_id }}</h1>
                                          <p>Issued: {{ $op->created_at }}<br>
                                              Payment Due: {{ $op->updated_at }}
                                          </p>
                                      </div>
                                      <!--End Title-->
                                  </div>
            ...
            <style>
              <blade import|%20url(https%3A%2F%2Ffonts.googleapis.com%2Fcss%3Ffamily%3DRoboto%3A100%2C300%2C400%2C900%2C700%2C500%2C300%2C100)%3B%0D>* {
                  margin: 0;
